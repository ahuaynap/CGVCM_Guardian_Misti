...
public static class GuardianMistiGameBuilder
{
    ...
    private static void BuildLevel(bool level2)
    {
        ...
        var app=new GameObject("App");var sceneLoader=app.AddComponent<SceneLoader>();if(!level2)app.AddComponent<SimulationSession>();new GameObject("GameplayCursorController").AddComponent<GameplayCursorController>();
