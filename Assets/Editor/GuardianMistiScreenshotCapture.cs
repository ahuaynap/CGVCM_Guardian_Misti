...
public static class GuardianMistiScreenshotCapture
{
    ...
    public static void CaptureScreenshots()
    {
        ...
        CaptureHudVariant("Assets/Scenes/Level01.unity","EarthquakeCountdown","El simulacro comenzará en 3...","Earthquake_Countdown");CaptureHudVariant("Assets/Scenes/Level01.unity","EarthquakeIntensity","Intensidad simulada: Sismo fuerte","Earthquake_Active");CaptureHudVariant("Assets/Scenes/Level01.unity","TimerText","01:23.450","HUD_Timer");
